    ...
    <div>
      {/* Social Link */}
        ...
        <div className='lg:px-0 md:px-0 sm:px-5 px-5 flex gap-8 justify-start mt-8'>
            <Link to="/About" className='text-black cursor-pointer hover:bg-[#001d48] hover:text-white hover:bg-transparent border border-[#e9af1d] transition duration-700 px-4 py-3 bg-[#e9af1d] rounded-sm text-base font-Montserrat font-medium'> About Me </Link>
